        ...
        <div class="x_panel">
            <div class="x_title">
                ...
                <div class="derecha">
                        ...
                        <a href="<?= site_url('/Administrador/Lista/Proveedores/Modificar/'.$proveedor['idProveedor'])?>" class="btn btn-default btn-editar " title="Modificar"><i class="fa fa-pencil fa-lg" aria-hidden="true"></i></a>
                </div>
